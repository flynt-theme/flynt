...
const GUIDE = {
    ...
    syntax: [
        { role: "Keyword",     token: "tx-2",  intent: "Reserved words - body-text weight, not colorized" },
        ...
        { role: "Variable",    token: "tx-3",  intent: "Variables and general identifiers" },
        { role: "Property",    token: "tx-4",  intent: "Object keys, struct fields - deliberately dim" },
    ...
    markup: [
        { role: "Heading",     token: "amber", intent: "Document headings" },
        { role: "Bold",        token: "tx",    intent: "Bold emphasis" },
        { role: "Italic",      token: "tx-2",  intent: "Italic emphasis" },
        { role: "Link text",   token: "delft", intent: "The display label of a link" },
        { role: "Link URL",    token: "teal",  intent: "The destination URL" },
        { role: "Code",        token: "moss",  intent: "Inline code and fenced blocks" },
        { role: "Blockquote",  token: "tx-5",  intent: "Quoted passages" },
        { role: "List marker", token: "rose",  intent: "Bullet points and list markers" },
    ],
};
